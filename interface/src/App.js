...
class App extends Component {
  constructor(props) {
    super(props);
    const loginStatus =
      sessionStorage.getItem("quizmaestro-isLoggedIn") === "LOGGED_IN"
        ? "LOGGED_IN"
        : "NOT_LOGGED_IN";
    this.state = {
  ...
  checkLogin = () => {
    return sessionStorage.getItem("quizmaestro-isLoggedIn") === "LOGGED_IN";
  };
  ...
  handleLogin = (response) => {
    this.setState({
      ...
      user: { ...response },
      authToken: sessionStorage.getItem("quizmaestro-authToken"),
    });
    sessionStorage.setItem("quizmaestro-isLoggedIn", "LOGGED_IN");
  };
  ...
  handleLogout = (event) => {
    ...
    sessionStorage.setItem("quizmaestro-isLoggedIn", "");
    sessionStorage.setItem("quizmaestro-authToken", "");
  };
